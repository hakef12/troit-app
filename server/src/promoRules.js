// Calcula el descuento automático de la promo del día sobre los items del carrito.
// `items` es un arreglo de { id, price, qty, category } (precios ya resueltos desde la BD).
// Duplicado en client/src/promoRules.js (mismo patrón que deliveryPricing.js) solo para
// mostrar una vista previa en el checkout — el servidor siempre vuelve a calcular el
// descuento real y es la única fuente de verdad para el cobro.
